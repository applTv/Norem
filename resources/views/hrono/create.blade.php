...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <div class="container">
            <form method="POST" action="{{route('hrono.store')}}" enctype="multipart/form-data">
                @csrf
                <div class="mb-3">
                  ...
                  <div class="mb-3">
                    ...
                    <textarea name="year_event"class="form-control" id="year_event" rows="1"></textarea>
                  </div>
                  <div class="mb-3">
                    <label for="title" class="form-label">Описание события</label>
                    <textarea name="title"class="form-control" id="title" rows="5"></textarea>
