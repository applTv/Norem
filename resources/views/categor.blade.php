        ...
        <div class="container ">
            ...
            <div class="container overflow-hidden text-center">
                    ...
                    <div class="p-3">
                        <div class="bg-image ripple" data-mdb-ripple-color="light">
                            ...
                            <a href="{{ route('diseases.index')}}">
                              <div class="mask" style="background-color: rgba(0, 0, 0, 0.4)">
                                <div class="d-flex justify-content-center align-items-center h-100">
                                  <p class="text-white mb-0">Болезни</p>
                                </div>
                              </div>
                              <div class="hover-overlay">
                                <div class="mask" style="background-color: rgba(251, 251, 251, 0.2)"></div>
                    ...
                    <div class="p-3">
                        <div class="bg-image ripple" data-mdb-ripple-color="light">
                            ...
                            <a href="{{ route('artifacts.index')}}">
                              <div class="mask" style="background-color: rgba(0, 0, 0, 0.568)">
                                <div class="d-flex justify-content-center align-items-center h-100">
                                  <p class="text-white mb-0">Артефакты</p>
                                </div>
                              </div>
                              <div class="hover-overlay">
                                <div class="mask" style="background-color: rgba(233, 230, 230, 0.2)"></div>
                              </div>
                            </a>
                          </div>
                    </div>
                ...
                <div class=" col-md-6 mb-6 ">
                    <div class="p-3">
                        <div class="bg-image ripple" data-mdb-ripple-color="light">
                            <img src="images/sverkh.png" class="w-100" />
                            <a href="{{ route('supernaturals.index')}}">
                              <div class="mask" style="background-color: rgba(0, 0, 0, 0.568)">
                                <div class="d-flex justify-content-center align-items-center h-100">
                                  <p class="text-white mb-0">Сверхестественные существа</p>
                                </div>
                              </div>
                              <div class="hover-overlay">
                                <div class="mask" style="background-color: rgba(251, 251, 251, 0.2)"></div>
                  ...
                  <div class=" col-md-6 mb-6 ">
                    <div class="p-3">
                        <div class="bg-image ripple" data-mdb-ripple-color="light">
                            <img src="images/org.png" class="w-100" />
                            <a href="{{ route('organiz.index')}}">
                              <div class="mask" style="background-color: rgba(0, 0, 0, 0.4)">
                                <div class="d-flex justify-content-center align-items-center h-100">
                                  <p class="text-white mb-0">Организации</p>
                                </div>
                              </div>
                              <div class="hover-overlay">
                                <div class="mask" style="background-color: rgba(251, 251, 251, 0.2)"></div>
                  ...
                  <div class="col-md-6 mb-6 ">
                    <div class="p-3">
                        <div class="bg-image ripple" data-mdb-ripple-color="light">
                            ...
                            <a href="{{ route('magic.index')}}">
                              <div class="mask" style="background-color: rgba(0, 0, 0, 0.4)">
                                <div class="d-flex justify-content-center align-items-center h-100">
                                  <p class="text-white mb-0">Магия</p>
                                </div>
                              </div>
                              <div class="hover-overlay">
                                <div class="mask" style="background-color: rgba(251, 251, 251, 0.2)"></div>
                  ...
                  <div class="col-md-6 mb-6 ">
                    <div class="p-3">
                        <div class="bg-image ripple" data-mdb-ripple-color="light">
                            <img src="{{asset('images/5.png')}}" class="w-100" />
                            <a href="{{ route('planets.index')}}">
                              <div class="mask" style="background-color: rgba(0, 0, 0, 0.4)">
                                <div class="d-flex justify-content-center align-items-center h-100">
                                  <p class="text-white mb-0">Планеты</p>
                                </div>
                              </div>
                              <div class="hover-overlay">
                                <div class="mask" style="background-color: rgba(251, 251, 251, 0.2)"></div>
                    ...
                    <div class="p-3">
                        <div class="bg-image ripple" data-mdb-ripple-color="light">
                            ...
                            <a href="{{ route('character.index')}}">
                              <div class="mask" style="background-color: rgba(0, 0, 0, 0.4)">
                                <div class="d-flex justify-content-center align-items-center h-100">
                                  <p class="text-white mb-0">Персонажи</p>
                                </div>
                              </div>
                              <div class="hover-overlay">
                                <div class="mask" style="background-color: rgba(251, 251, 251, 0.2)"></div>
