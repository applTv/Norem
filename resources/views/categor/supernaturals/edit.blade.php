...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <div class="container">
            <form method="POST" action="{{route('supernaturals.update', $supernatural)}}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="mb-3">
                <label for="supernatural_name" class="form-label">Название сверхестественного существа</label>
                <textarea name="supernatural_name"class="form-control" id="supernatural_name" rows="1">{{$supernatural-> supernatural_name}}</textarea>
              </div>
              <div class="mb-3">
                <label for="content" class="form-label">Описание Cверхественного существа</label>
                <textarea name="content"class="form-control" id="content" rows="10">{{$supernatural-> content}}</textarea>
              </div>
              <div class="mb-3">
                <label for="supernatural_add" class="form-label">Дополнительная информация</label>
                <textarea name="supernatural_add"class="form-control" id="supernatural_add" rows="5">{{$supernatural-> supernatural_add}}</textarea>
