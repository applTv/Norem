...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{$supernatural-> supernatural_name}}</title>
        ...
        <div class="container">
            <nav aria-label="breadcrumb m-3">
                <ol class="breadcrumb m-4">
                  ...
                  <li class="breadcrumb-item"><a href="{{ route('supernaturals.index')}}">Cверхественные существа</a></li>
                  <li class="breadcrumb-item active" aria-current="page">{{$supernatural-> supernatural_name}}</li>
                </ol>
              </nav>  
            <h2 class="p-3 text-center"> <b>{{$supernatural-> supernatural_name}}</b></h2>
            <h3 class="m-3"><b>Описание Cверхественного существа</b></h3>
            <?php
            echo nl2br("<p>{$supernatural-> content}
            </p>"); ?>
            <h3 class="m-3"><b>Дополнительная информация</b></h3>
            <?php
            echo nl2br("<p>{$supernatural-> supernatural_add}
            </p>"); ?>
        </div>
