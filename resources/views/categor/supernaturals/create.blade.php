...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <div class="container">
            <form method="POST" action="{{route('supernaturals.store')}}" enctype="multipart/form-data">
            @csrf
              <div class="mb-3">
                  <label for="supernatural_name" class="form-label">Название сверхестественного существа</label>
                  <textarea name="supernatural_name"class="form-control" id="supernatural_name" rows="1"></textarea>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                  ...
                  <textarea name="supernatural_add"class="form-control" id="supernatural_add" rows="5"></textarea>
                </div>
