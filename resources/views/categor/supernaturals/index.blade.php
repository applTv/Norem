...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Cверхественные существа</title>
    ...
    <div class="container">
        ...
        <h2 class="p-3 text-center">Cверхественные существа</h2>
        <div class="row">
            <div class="col-lg-5 col-md-4 mb-4 mb-md-0 imgdiv"></div>
            <div class="col-lg-2 col-md-4 mb-4 mb-md-0 imgdiv">
              @auth
              @if(Auth::user()->isAdmin())
                <a href="{{ route('supernaturals.create') }}" class="btn btn-danger m-3">Добавить Сверхестественное существо</a>       
              @endif
        @endauth
  <div class="list-group list-group-light">
      @foreach ($supernaturals as $supernatural)
      <a href="{{ route('supernaturals.show' , $supernatural->id) }}" class="list-group-item list-group-item-action px-3 border-0">
        <h5>{{$supernatural-> supernatural_name}}</h5></a>
        @auth
          @if(Auth::user()->isAdmin())
          <div class="d-grid gap-2 d-md-block">
              <a href="{{ route('supernaturals.edit', $supernatural) }}" class="btn-outline-danger btn-sm m-2 me-md-2" role="button">Изменить</a>
              <form method="POST" action="{{route('supernaturals.destroy', $supernatural)}}">
                @csrf
                @method('DELETE')
