...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <div class="container">
            <form method="POST" action="{{route('organiz.update', $organiz)}}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
            <div class="mb-3">
                <label for="exampleFormControlTextarea1" class="form-label">Изменить название организации</label>
                <textarea name="Organiz_name"class="form-control" id="exampleFormControlTextarea1" rows="1">{{$organiz -> Organiz_name}}</textarea>
              </div>
              <div class="mb-3">
                <label for="exampleFormControlTextarea1" class="form-label">Изменить описание организации</label>
                <textarea name="content"class="form-control" id="exampleFormControlTextarea1" rows="10">{{$organiz -> content}}</textarea>
              </div>
              <div class="mb-3">
                <label for="images1" class="form-label">Изображение организации 1</label>
                <input name="images1"class="form-control" type="file" rows="1">
              </div>
              <div class="mb-3">
                <label for="images2" class="form-label">Изображение организации 2</label>
                <input name="images2"class="form-control" type="file" rows="1">
              </div>
              <div class="mb-3">
                <label for="images3" class="form-label">Изображение организации 3</label>
                <input name="images3"class="form-control" type="file" rows="1">
              </div>
              <div class="mb-3">
                <label for="images4" class="form-label">Изображение организации 4</label>
