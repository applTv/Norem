...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{$organiz-> Organiz_name}}</title>
        ...
        <div class="container">
          <nav aria-label="breadcrumb m-3">
            <ol class="breadcrumb m-4">
              ...
              <li class="breadcrumb-item"><a href="{{ route('organiz.index')}}">Организации</a></li>
              <li class="breadcrumb-item active" aria-current="page">{{$organiz-> Organiz_name}}</li>
            </ol>
          </nav>
            
          <h2 class="p-3 text-center"> {{$organiz-> Organiz_name}}</h2>
            <?php
            echo nl2br("
            <p>
                {$organiz-> content}
            </p>"); ?>
            <img src="/images/organiz/{{$organiz -> images1}}" alt="..." class="img-fluid p-2">
            <img src="/images/organiz/{{$organiz -> images2}}" alt="..." class="img-fluid p-2">
            <img src="/images/organiz/{{$organiz -> images3}}" alt="..." class="img-fluid p-2">
            <img src="/images/organiz/{{$organiz -> images4}}" alt="..." class="img-fluid p-2">
            

              {{-- <h2 class="p-3 text-center"> Персонажи организации</h2>
              <div class="row">
                <div class="col-lg-6 col-md-4 mb-4 mb-md-0 imgdiv">
            <div class="list-group list-group-light">
              @foreach ($characters as $character)
                <a href="{{ route('character.show' , $character->id) }}" class="list-group-item list-group-item-action px-3 border-0">
