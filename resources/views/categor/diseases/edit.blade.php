...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <div class="container">
            <form method="POST" action="{{route('diseases.update', $disease)}}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
              <div class="mb-3">
                  <label for="exampleFormControlTextarea1" class="form-label">Название болезни</label>
                  <textarea name="disease_name"class="form-control" id="exampleFormControlTextarea1" rows="1">{{$disease-> disease_name}}</textarea>
                </div>
                <div class="mb-3">
                  <label for="exampleFormControlTextarea1" class="form-label">Симптомы болезни</label>
                  <textarea name="symptoms"class="form-control" id="exampleFormControlTextarea1" rows="10">{{$disease-> symptoms}}</textarea>
                </div>
                <div class="mb-3">
                  <label for="exampleFormControlTextarea1" class="form-label">Смертность болезни</label>
                  <textarea name="mortality"class="form-control" id="exampleFormControlTextarea1" rows="1">{{$disease-> mortality}}</textarea>
                </div>
                <div class="mb-3">
                  <label for="exampleFormControlTextarea1" class="form-label">Описание болезни</label>
                  <textarea name="description"class="form-control" id="exampleFormControlTextarea1" rows="2">{{$disease-> description}}</textarea>
                </div>
                <div class="mb-3">
                  <label for="exampleFormControlTextarea1" class="form-label">Дополнительная информация</label>
                  <textarea name="diseases_add"class="form-control" id="exampleFormControlTextarea1" rows="4">{{$disease-> diseases_add}}</textarea>
                </div>
