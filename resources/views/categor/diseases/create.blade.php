        ...
        <div class="container">
            ...
            @csrf
              <div class="mb-3">
                  ...
                  <textarea name="disease_name"class="form-control" id="exampleFormControlTextarea1" rows="1"></textarea>
                </div>
                <div class="mb-3">
                  <label for="exampleFormControlTextarea1" class="form-label">Симптомы болезни</label>
                  <textarea name="symptoms"class="form-control" id="exampleFormControlTextarea1" rows="10"></textarea>
                </div>
                <div class="mb-3">
                  <label for="exampleFormControlTextarea1" class="form-label">Смертность болезни</label>
                  <textarea name="mortality"class="form-control" id="exampleFormControlTextarea1" rows="1"></textarea>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                  ...
                  <textarea name="diseases_add"class="form-control" id="exampleFormControlTextarea1" rows="4"></textarea>
                </div>
