...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{$disease-> disease_name}}</title>
        ...
        <div class="container">
            <nav aria-label="breadcrumb m-3">
                <ol class="breadcrumb m-4">
                  ...
                  <li class="breadcrumb-item"><a href="{{ route('diseases.index')}}">Болезни</a></li>
                  <li class="breadcrumb-item active" aria-current="page">{{$disease-> disease_name}}</li>
                </ol>
              </nav>
            <h2 class="p-3 text-center"> <b>{{$disease-> disease_name}}</b></h2>
            <h3 class="m-3"><b>Симптомы болезни</b></h3>
            <?php
            echo nl2br("<p>{$disease-> symptoms}
            </p>"); ?>
            <h3 class="m-3"><b>Смертность болезни</b></h3>
            <?php
            echo nl2br("<p>{$disease-> mortality}
            </p>"); ?>
            <h3 class="m-3"><b>Описание болезни</b></h3>
            <?php
            echo nl2br("<p>{$disease-> description}
            </p>"); ?>
            <h3 class="m-3"><b>Дополнительная информация</b></h3>
            <?php
            echo nl2br("<p>{$disease-> diseases_add}
            </p>"); ?>
        </div>
