...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <div class="container">
            ...
            <h2 class="p-3 text-center"> Расы</h2>
                ...
                <div class="col-lg-3 col-md-4 mb-4 mb-md-0 imgdiv">
                    @auth
                            @if(Auth::user()->isAdmin())
                                ...
                                <a href="{{ route('races.create') }}" class="btn btn-danger m-3">Добавить расу</a>
                            @endif
                    @endauth
                    <div class="list-group list-group-light p-3">
                        @foreach ($races as $race)
                            <a href="{{ route('races.show' , $race->id) }}" class="list-group-item list-group-item-action px-2 border-0">
                                <h5>{{$race-> race_name}}</h5></a>
                        @auth
                            @if(Auth::user()->isAdmin())
                            <div class="d-grid gap-2 d-md-block">
                                <a href="{{ route('races.edit', $race) }}" class="btn-outline-danger btn-sm m-2 me-md-2" role="button">Изменить</a>
                            ...
                            @endif
                        @endauth
                        <form action="{{url('/add_race',$race->id)}}" method="POST">
                            @csrf
