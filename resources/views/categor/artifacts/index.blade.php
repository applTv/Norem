...
<div class="container">
    ...
    <h2 class="p-3 text-center">Артефакты</h2>
    <div class="row">
    ...
    <div class="list-group list-group-light">
              @auth
                  @if(Auth::user()->isAdmin())
                    <a href="{{ route('artifacts.create') }}" class="btn btn-danger m-3">Добавить болезнь</a>       
                  @endif
              @endauth
        <div class="list-group list-group-light">
            @foreach ($artifacts as $artifact)
                <a href="{{ route('artifacts.show' , $artifact->id) }}" class="list-group-item list-group-item-action px-3 border-0">
                  <h5>{{$artifact-> artifacts_name}}</h5></a>
                @auth
                  @if(Auth::user()->isAdmin())
                  <div class="d-grid gap-2 d-md-block">
                      <a href="{{ route('artifacts.edit', $artifact) }}" class="btn-outline-danger btn-sm m-2 me-md-2" role="button">Изменить</a>
