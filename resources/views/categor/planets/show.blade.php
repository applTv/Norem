...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{$planet-> planets_name}}</title>
        ...
        <div class="container">
            <nav aria-label="breadcrumb m-3">
                <ol class="breadcrumb m-4">
                  ...
                  <li class="breadcrumb-item"><a href="{{ route('planets.index')}}">Планеты</a></li>
                  <li class="breadcrumb-item active" aria-current="page">{{$planet-> planets_name}}</li>
                </ol>
              </nav>
            <div class="row">
                <div class="col-md-6 mb-6">
                    <img src="/images/planet/{{$planet-> images}}" alt="..." class="img-fluid p-2 ">
                </div>
                <div class="col-md-6 mb-6">
                  <h3 class="m-3"><b>Название палнеты: </b></h3>
                  <?php
                  echo nl2br("<p>{$planet-> planets_name}</p>"); ?>
                  <h3 class="m-3"><b>Климат: </b></h3>
                  <?php
                  echo nl2br("<p>{$planet-> climate}</p>"); ?>
                  <h3 class="m-3"><b>Описание планеты: </b></h3>
                  <?php
                  echo nl2br("<p>{$planet-> description}</p>"); ?>
                  <h3 class="m-3"><b>Население: </b></h3>
                  <?php
                  echo nl2br("<p>{$planet-> population}</p>"); ?>
                  <h3 class="m-3"><b>Количество дней и часов в сутках: </b></h3>
                  <?php
                  echo nl2br("<p>{$planet-> time}</p>"); ?>
                </div>
