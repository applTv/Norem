    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="mb-3">
                ...
                <textarea name="planets_name"class="form-control" id="planets_name" rows="1"></textarea>
              </div>
              <div class="mb-3">
                <label for="climate" class="form-label">Климат:</label>
                <textarea name="climate"class="form-control" id="climate" rows="3"></textarea>
              </div>
              <div class="mb-3">
              ...
              <div class="mb-3">
                ...
                <textarea name="population"class="form-control" id="population" rows="4"></textarea>
              </div>
              <div class="mb-3">
                <label for="time" class="form-label">Количество дней и часов в сутках: </label>
                <textarea name="time"class="form-control" id="time" rows="2"></textarea>
              </div>
              <div class="mb-3">
