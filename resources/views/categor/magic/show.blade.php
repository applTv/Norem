        ...
        <div class="container">
            <nav aria-label="breadcrumb m-3">
                <ol class="breadcrumb m-4">
                  ...
                  <li class="breadcrumb-item"><a href="{{ route('magic.index')}}">Магия</a></li>
                  <li class="breadcrumb-item active" aria-current="page">{{$magic-> magic_name}}</li>
                </ol>
              </nav>  
            <h2 class="p-3 text-center"> <b>{{$magic-> magic_name}}</b></h2>
            <h3 class="m-3"><b>Легальность магии</b></h3>
            <?php
            echo nl2br("<p>{$magic-> legality}
            </p>"); ?>
            <h3 class="m-3"><b>Кто может использовать магию</b></h3>
            <?php
            echo nl2br("<p>{$magic-> restrictions}
            </p>"); ?>
            <h3 class="m-3"><b>Для чего используется</b></h3>
            <?php
            echo nl2br("<p>{$magic-> magic_description}
            </p>"); ?>
            <h3 class="m-3"><b>Дополнительная информация</b></h3>
            <?php
            echo nl2br("<p>{$magic-> add_description}
            </p>"); ?>
        </div>
