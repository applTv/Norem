...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <div class="container">
            <form method="POST" action="{{route('magic.store')}}" enctype="multipart/form-data">
            @csrf
              <div class="mb-3">
                  <label for="magic_name" class="form-label">Название магии</label>
                  <textarea name="magic_name"class="form-control" id="magic_name" rows="1"></textarea>
                </div>
                <div class="mb-3">
                  <label for="legality" class="form-label">Легальность магии</label>
                  <textarea name="legality"class="form-control" id="legality" rows="1"></textarea>
                </div>
                <div class="mb-3">
                  <label for="restrictions" class="form-label">Кто может использовать магию</label>
                  <textarea name="restrictions"class="form-control" id="restrictions" rows="1"></textarea>
                </div>
                <div class="mb-3">
                  <label for="magic_description" class="form-label">Для чего используется</label>
                  <textarea name="magic_description"class="form-control" id="magic_description" rows="5"></textarea>
                </div>
                <div class="mb-3">
                  <label for="add_description" class="form-label">Дополнительная информация</label>
                  <textarea name="add_description"class="form-control" id="add_description" rows="5"></textarea>
                </div>
